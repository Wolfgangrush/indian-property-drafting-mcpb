"""wolfgang_rush — Indian Property & Conveyancing Drafting MCPB.
...
FULL_ORCHESTRATION_SCRIPT = """# wolfgang_rush — INDIAN CIVIL COURTS (PROPERTY SUITS, PARTITION, DECLARATION, POSSESSION) DRAFTING · FULL ORCHESTRATION SCRIPT
